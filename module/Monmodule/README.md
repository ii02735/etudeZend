...
```bash
$ cd module
$ git clone https://github.com/zendframework/Monmodule MyNewModule
$ cd MyNewModule
```
...
`src/Controller/MonmoduleController.php`, and replace any occurence of
`Monmodule` with your new namespace.
...
> > sed --in-place -e 's/Monmodule/MyNewModule/g' $php
> > done
> ```
